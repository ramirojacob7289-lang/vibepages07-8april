...
_Hasync.push(['Histats.start', '1,5019171,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?5019171&101" alt="website free tracking" border="0"></a></noscript>
<!-- Histats.com  END  -->
    <meta charset="utf-8">
    ...
    -->
    <title>Dragonfruit Template</title>
    ...
    <ul>
        ...
        <li class="templatemo_banner_slide_03">
            <div class="slide_caption">
                ...
                <p>Pellentesque luctus ac nunc et hendrerit. Aliquam eu scelerisque eros. Vestibulum scelerisque mi nec augue condimentum rhoncus. Cras fermentum convallis elementum.</p>
            </div>
        </li>
    </ul>
</div>
...
<div id="templatemo_mobile_menu">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li><a rel="nofollow" href="http://www.facebook.com/templatemo" class="external-link"><i class="glyphicon glyphicon-export"></i> &nbsp; External</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-8 hidden-xs">
                <ul class="nav nav-justified">
                    ...
                    <li><a rel="nofollow" href="http://www.facebook.com/templatemo" class="external-link">External</a></li>
        ...
        <div id="testimonial_text_wap" class="col-xs-9 col-sm-10">
              <div class="testimonial_text">
                ...
                <div class="col-sm-9">
                    ...
                    <p>Dragonfuit is free website template for any purpose. You do not have to put a credit link on your website when you use this template. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.</p>
                </div>
            </div><!--.testimonial_text-->
            <div class="testimonial_text">
                <div class="col-sm-3">
                    <img src="images/templatemo_member_02.jpg" class="img-responsive" alt="Public Relation Officer" />
                </div>
                <div class="col-sm-9">
                    <h2>Mary Yang</h2>
                    <h3>Public Relation Officer</h3>
                    <p>Fusce et orci mollis, congue lorem vitae, semper erat. Curabitur quis pellentesque nisl, at adipiscing libero. Integer at sem dui. Fusce posuere aliquet dolor, at viverra odio accumsan sed. Sed pharetra vel risus a convallis. Maecenas in adipiscing libero, id molestie odio. Thank you.</p>
                </div>
            </div><!--.testimonial_text-->
            <div class="testimonial_text">
                <div class="col-sm-3">
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-0">
            <div class="event_box_wap event_animate_left">
                ...
                <div class="event_box_caption">
                    ...
                    <p><span class="glyphicon glyphicon-map-marker"></span> New Hotel, Bangkok, Thailand &nbsp;&nbsp; <span class="glyphicon glyphicon-time"></span> 5:30 PM to 8:30 PM</p>
        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-0">
            <div class="event_box_wap event_animate_right">
                ...
                <div class="event_box_caption">
                    <h1>Free Bootstrap Workshop</h1>
                    <p><span class="glyphicon glyphicon-map-marker"></span> Digital Hall, Yangon, Myanmar &nbsp;&nbsp; <span class="glyphicon glyphicon-time"></span> 11:00 AM to 2:00 PM </p>
        ...
        <div class="col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-0">
            <div class="event_box_wap event_animate_left">
                ...
                <div class="event_box_caption">
                    ...
                    <p><span class="glyphicon glyphicon-map-marker"></span> Old Town Center, Mandalay, Myanmar &nbsp;&nbsp; <span class="glyphicon glyphicon-time"></span> 4:15 PM to 7:15 PM </p>
